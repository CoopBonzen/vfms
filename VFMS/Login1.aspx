<%@ Page Language="vb" AutoEventWireup="true" CodeBehind="Login1.aspx.vb" %>
...
<body>
    ...
    <div class="login">
        ...
        <input id="password_tb" type="password" placeholder="password" name="password" runat="server"><br>
        <input id="btn_Login" type="button" value="Login" runat="server" /><br>
    </div>
